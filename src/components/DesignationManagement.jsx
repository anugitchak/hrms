...
const DesignationManagement = () => {
    ...
    const filteredDesignations = designations.filter((designation) => {
        ...
        const matchesDept = departmentFilter ? String(designation.department_id) === departmentFilter : true;
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                <div>
                    <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-none mb-3">
                        Designation <span className="text-transparent bg-clip-text bg-[#00b9cd]">Management</span>
                    </h1>
            ...
            <div className="flex-1">
                ...
                <div className="bg-white dark:bg-slate-900/60 dark:backdrop-blur-md p-5 rounded-10 shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out mb-10 flex flex-col md:flex-row gap-5">
                    <div className="relative flex-1 max-w-md group">
                        ...
                        <input
                            ...
                            className="pl-12 pr-6 w-full py-3 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-10 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-medium text-slate-900 dark:text-white placeholder-slate-400 transition-all"
                            value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
                        />
                    </div>
                    <select
                        className="py-3 px-4 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-10 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-medium text-slate-900 dark:text-white transition-all"
                ...
                {loading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
                        {[1,2,3].map(i => (
                            <div key={i} className="bg-white dark:bg-slate-900/40 p-6 rounded-10 shadow-sm animate-pulse border-2 border-slate-100 dark:border-white/5">
                    ...
                    <div className="bg-white dark:bg-slate-900/60 dark:backdrop-blur-md p-20 text-center flex flex-col items-center gap-6 mt-4 rounded-10 shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out border-4 border-dashed border-slate-200 dark:border-white/10">
                                ...
                                <div className="mb-8">
                                    <div className="flex items-start justify-between mb-6">
                                        <div className="flex items-center gap-4">
                                            <div className="w-14 h-14 rounded-10 bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center text-xl font-black border border-white/20 shadow-md group-hover:scale-110 transition-transform duration-500">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    <div className={`w-2 h-2 rounded-10 ${designation.is_active ? 'bg-green-500' : 'bg-red-500'}`} />
                                                ...
                                                {designation.department && (
                                                    <span className="inline-block mt-1 text-[9px] font-black uppercase tracking-widest bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-10 border border-blue-100 dark:border-blue-500/20">
                                ...
                                {canManage && (
                                    <div className="flex items-center gap-3 pt-6 border-t-2 border-slate-50 dark:border-white/5">
                                        ...
                                        <button onClick={() => handleDelete(designation.id)}
                                            className="w-10 h-10 flex items-center justify-center rounded-10 border-2 border-slate-900/10 dark:border-white/10 text-slate-400 dark:text-slate-500 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all group/btn"
                                            title="Delete">
                ...
                <div className="fixed inset-0 bg-slate-900/40 dark:bg-black/60 flex items-center justify-center z-50 p-4 border-none backdrop-blur-md ">
                    <div className="bg-white dark:bg-slate-900/80 dark:backdrop-blur-xl shadow-2xl shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out w-full max-w-lg overflow-hidden transform rounded-10">
                        ...
                        <div className="px-8 py-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-center bg-white dark:bg-transparent">
                            ...
                            <button onClick={handleCloseModal} className="p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-10 transition-colors text-slate-400 dark:text-slate-500">
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            <div>
                                <label className="block text-xs font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-3 ml-1">
                                    Department
                                </label>
                                <select
                                    id="designation_department" name="department_id"
                                    className="w-full px-6 py-4 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-10 outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 font-bold text-slate-900 dark:text-white transition-all"
                                ...
                                {errors.department_id && <p className="text-red-500 text-[10px] font-black uppercase mt-2 ml-1 tracking-wider">{errors.department_id[0]}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-6 py-4 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-10 outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 font-bold text-slate-900 dark:text-white placeholder-slate-400 transition-all resize-none h-32"
