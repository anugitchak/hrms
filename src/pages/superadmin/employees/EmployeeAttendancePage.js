    ...
    if (error) {
        return (
            <div className="p-10 text-center animate-in fade-in zoom-in-95">
                <div className="bg-rose-50 dark:bg-rose-900/10 border-2 border-rose-500/20 p-8 rounded-10 inline-block">
        ...
        <div className="p-10 max-w-[1600px] mx-auto min-h-screen animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                <div className="relative group">
                    <div className="absolute -inset-4 bg-indigo-500/5 rounded-10 blur-2xl group-hover:bg-indigo-500/10 transition-all duration-500"></div>
                    <div className="relative">
                        <h1 className="text-5xl font-black text-slate-900 dark:text-white font-paperlogy tracking-tight lowercase">
                            Deployment <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">History</span>
                        </h1>
                        <div className="flex items-center gap-3 mt-4">
                            <span className="h-1.5 w-12 bg-gradient-to-r from-indigo-500 to-violet-500 rounded-10 shadow-lg shadow-indigo-500/20"></span>
                ...
                <div className="flex items-center gap-4">
                    <Link
                        ...
                        className="px-8 py-5 bg-white dark:bg-slate-900 text-slate-900 dark:text-white border-2 border-slate-900/10 rounded-10 text-[10px] font-black uppercase tracking-widest shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out hover:bg-slate-50 dark:hover:bg-slate-800 transition-all active:translate-y-1 active:shadow-none flex items-center gap-3"
                    >
                        <ArrowLeft size={16} />
                        Return to Hub
                    </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {[
                    ...
                    <div key={i} className="group relative">
                        <div className={`absolute inset-0 bg-${stat.color}-500 blur-xl opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-10`}></div>
                        <div className="relative bg-white dark:bg-slate-900 p-8 rounded-10 border-2 border-slate-900/10 shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out transition-all flex items-center justify-between">
                            <div>
                            ...
                            <div className={`w-14 h-14 bg-${stat.color}-50 dark:bg-${stat.color}-500/10 rounded-10 flex items-center justify-center`}>
            ...
            {/* Controls Bar */}
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6 mb-8 bg-slate-900 dark:bg-indigo-600 p-6 rounded-10 shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out">
                <div className="flex items-center gap-4">
                    <button 
                        onClick={() => handleMonthChange(-1)} 
                        className="p-3 bg-white/10 hover:bg-white/20 text-white rounded-10 transition-all active:scale-95"
                    >
                        <ChevronLeft size={20} />
                    </button>
                    <div className="relative bg-white/10 rounded-10 px-2 py-1 flex items-center gap-3 border border-white/20">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        ...
                        className="p-4 bg-white/10 hover:bg-white/20 text-white rounded-10 transition-all flex items-center gap-2 text-[10px] font-black uppercase tracking-widest active:scale-95"
                    >
                    ...
                    <button 
                        ...
                        className="p-4 bg-emerald-500 hover:bg-emerald-400 text-white rounded-10 transition-all flex items-center gap-2 text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20 active:scale-95"
                    >
                        <Download size={16} />
                        Export Log
                    </button>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-10 border-2 border-slate-900/10 shadow-md dark:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.4),0_4px_6px_-2px_rgba(0,185,205,0.1)] border border-transparent hover:shadow-lg dark:hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.5),0_10px_10px_-5px_rgba(0,185,205,0.15)] border-2 border-transparent hover:border-[#00b9cd] dark:hover:border-[#00b9cd] transition-all duration-500 ease-out overflow-hidden ">
                {loading ? (
                    <div className="py-32 flex flex-col items-center justify-center">
                        <div className="w-16 h-16 border-4 border-slate-900/5 border-t-indigo-600 rounded-10 animate-spin"></div>
                                ...
                                {attendanceData.data.length === 0 ? (
                                    <tr>
                                        <td colSpan="5" className="px-8 py-20 text-center">
                                            <div className="bg-slate-50 dark:bg-white/5 inline-block p-8 rounded-10 border-2 border-dashed border-slate-900/10">
                                    ...
                                    attendanceData.data.map((record) => (
                                        <tr key={record.id} className="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all group">
                                            <td className="px-8 py-6 whitespace-nowrap">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-10 h-10 bg-slate-100 dark:bg-white/10 rounded-10 flex items-center justify-center text-slate-500 font-paperlogy text-xs font-black">
                                            ...
                                            <td className="px-8 py-6 whitespace-nowrap">
                                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-3 py-1 bg-slate-100 dark:bg-white/10 rounded-10">
                                                    {new Date(record.date).toLocaleDateString('en-US', { weekday: 'long' })}
                                                </span>
                                            </td>
                                            <td className="px-8 py-6 whitespace-nowrap">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-2 h-2 rounded-10 bg-emerald-500"></div>
                                            ...
                                            <td className="px-8 py-6 whitespace-nowrap">
                                                <span className={`px-4 py-2 rounded-10 text-[10px] font-black uppercase tracking-widest border-2 ${getStatusStyles(record.status)}`}>
                                                    {record.status}
                                                </span>
                                            </td>
                                        </tr>
                ...
                {attendanceData.meta.last_page > 1 && (
                    <div className="flex justify-between items-center p-8 bg-slate-50 dark:bg-white/5 border-t-2 border-slate-900/5">
                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-4 py-2 bg-white dark:bg-white/5 rounded-10 border border-slate-900/5">
                        ...
                        <div className="flex gap-4">
                            <button 
                                ...
                                className="px-6 py-3 border-2 border-slate-900/10 rounded-10 text-[10px] font-black uppercase tracking-widest transition-all bg-white dark:bg-slate-900 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed shadow-md"
                            >
                                Previous
                            </button>
                            <button 
