        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-500 rounded-2xl p-8 text-white mb-8 shadow-lg flex justify-between items-center flex-wrap gap-4">
            ...
            <div className="flex gap-4">
                <div className="text-right bg-white/10 px-5 py-3 rounded-xl backdrop-blur-sm border border-white/10">
                    <div className="text-xs opacity-70 uppercase tracking-wider mb-1 font-bold">Reputation</div>
                    <div className="flex items-center justify-end gap-2">
                        <span className="text-2xl font-black">{profile?.employee?.reputation_score || 0}</span>
