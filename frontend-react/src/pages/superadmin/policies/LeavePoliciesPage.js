        ...
        <div className="p-8 max-w-[1600px] mx-auto min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                <div>
                    <h1 className="text-5xl md:text-5xl font-black text-slate-900 dark:text-white font-paperlogy tracking-tight">
                        <span className="italic">Leave Policy</span> <span className="text-transparent bg-clip-text bg-[#00b9cd]">Master</span>
                    </h1>
                ...
                {Object.entries(groupedPolicies).map(([category, categoryPolicies]) => (
                    <div key={category} className="space-y-6">
                        <div className="flex items-center gap-4 mb-4">
                            <div className={`w-2.5 h-10 rounded-full ${category === 'Permanent' ? 'bg-brand-500' : category === 'Intern' ? 'bg-orange-500' : 'bg-blue-500'}`}></div>
                            ...
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest bg-white dark:bg-slate-900/60 px-4 py-2 rounded-xl border border-slate-900/5 shadow-sm">
                                {categoryPolicies.length} Active
                            </span>
                        </div>

                        {categoryPolicies.length === 0 ? (
                            <div className="bg-slate-50/50 dark:bg-slate-900/40 rounded-[2.5rem] border-2 border-dashed border-slate-900/10 dark:border-white/10 p-12 text-center">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                                {categoryPolicies.map(policy => (
                                    <div key={policy.id} className="bg-white dark:bg-slate-900/60 dark:backdrop-blur-md rounded-[2.5rem] shadow-[8px_8px_0px_0px_rgba(71,85,105,0.15)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)] border-2 border-slate-900/5 dark:border-white/5 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group">
                                        <div 
                                        ...
                                        >
                                            <div className="flex-1 space-y-3">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border-2 ${policy.status === 'Active' ? 'bg-brand-50 text-brand-600 border-brand-200 shadow-sm' : 'bg-slate-100 text-slate-400 border-slate-200'}`}>
                                                        {policy.status}
                                                    </span>
                                                </div>
                                            ...
                                            <div className="flex items-center gap-2" onClick={e => e.stopPropagation()}>
                                                <div className="flex items-center gap-2 lg:opacity-0 lg:group-hover:opacity-100 transition-all duration-300">
                                                    <button 
                                                        ...
                                                        className="px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-blue-600 bg-blue-50 hover:bg-white rounded-xl shadow-sm border border-transparent hover:border-blue-100 transition-all"
                                                        title="Sync Balances"
                                                    >
                                                        Recalculate
                                                    </button>
                                                    <button 
                                                        ...
                                                        className="px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-purple-600 bg-purple-50 hover:bg-white rounded-xl shadow-sm border border-transparent hover:border-purple-100 transition-all"
                                                    >
                                                        Carry Over
                                                    </button>
                                                    ...
                                                    <button 
                                                        ...
                                                        className="p-3 text-slate-400 hover:text-brand-500 hover:bg-white dark:hover:bg-slate-800 rounded-xl transition-all"
                                                    >
                                            ...
                                            <div className="px-8 pb-10 pt-4 bg-slate-50/50 dark:bg-slate-800/20 border-t border-slate-900/5 dark:border-white/5 animate-in slide-in-from-top-4 duration-300">
                                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                    {policy.rules.map(rule => (
                                                        <div key={rule.id} className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-900/5 shadow-sm relative overflow-hidden group/rule">
                                                            ...
                                                            <div className="space-y-3">
                                                                ...
                                                                <div className="flex justify-between items-center pt-1">
                                                                    ...
                                                                    <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-lg ${rule.auto_approve ? 'bg-green-50 text-green-600' : 'bg-orange-50 text-orange-600'}`}>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-slate-900 rounded-[3rem] w-full max-w-6xl max-h-[92vh] overflow-hidden flex flex-col shadow-[12px_12px_0px_0px_rgba(71,85,105,0.3)] dark:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.1)] border-2 border-slate-900 dark:border-white/10 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <form onSubmit={handleSubmit} className="overflow-auto px-10 pb-10 flex-1 space-y-10 scrollbar-hide">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                <div className="md:col-span-2 group">
                                    ...
                                    <input 
                                        required
                                        className="w-full px-6 py-4 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-2xl outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 font-bold text-slate-900 dark:text-white transition-all font-paperlogy"
                                        value={formData.name}
                                ...
                                <div>
                                    ...
                                    <select 
                                        className="w-full px-6 py-4 bg-slate-50 dark:bg-white/5 border-2 border-slate-900/10 dark:border-white/10 rounded-2xl outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 font-bold text-slate-900 dark:text-white transition-all appearance-none"
                            ...
                            <div className="bg-orange-50/80 dark:bg-orange-500/10 p-6 rounded-3xl border-2 border-orange-100 dark:border-orange-500/20 flex items-center gap-4">
                                <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl shadow-sm flex items-center justify-center text-orange-500">
                            ...
                            <div>
                                ...
                                <div className="bg-white dark:bg-slate-900/40 rounded-[2.5rem] border-2 border-slate-900/5 dark:border-white/5 overflow-hidden shadow-sm">
                                                    ...
                                                    <tr key={lt.id} className="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors">
                                                        ...
                                                        <td className="p-6">
                                                            <input 
                                                                ...
                                                                className="w-24 mx-auto px-4 py-2 bg-slate-50 dark:bg-slate-800 border-2 border-slate-900/10 dark:border-white/10 rounded-xl outline-none focus:border-brand-500 text-center font-black text-slate-900 dark:text-white tabular-nums"
                                                        ...
                                                        <td className="p-6 text-center">
                                                            <select 
                                                                className="px-4 py-2 bg-slate-50 dark:bg-slate-800 border-2 border-slate-900/10 dark:border-white/10 rounded-xl outline-none focus:border-brand-500 font-black text-[10px] uppercase tracking-widest text-slate-600 dark:text-slate-300 appearance-none text-center min-w-[120px]"
                                                        ...
                                                        <td className="p-6 text-center">
                                                            <label className="inline-flex items-center gap-3 cursor-pointer group/toggle">
                                                                <div className="relative w-12 h-6 bg-slate-100 dark:bg-slate-800 rounded-full border border-slate-900/5 transition-colors group-hover:bg-slate-200 peer-checked:bg-orange-500">
                                                                    <input 
                                                                        type="checkbox" className="sr-only peer"
                                                                        checked={rule.probation_restriction ?? false}
                                                                        onChange={e => handleRuleChange(idx, 'probation_restriction', e.target.checked)}
                                                                    />
                                                                    <div className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full shadow-sm transition-transform duration-200 ${rule.probation_restriction ? 'translate-x-6' : ''}`}></div>
                                                                </div>
                        ...
                        <div className="px-10 py-8 bg-slate-50/50 dark:bg-slate-800/50 border-t-2 border-slate-900/5 dark:border-white/10 flex justify-end gap-4">
                            ...
                            <button 
                                ...
                                className="px-10 py-4 bg-brand-500 hover:bg-brand-600 text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-lg active:translate-y-0.5 transition-all flex items-center gap-4 disabled:opacity-50"
                            >
                                {isSubmitting ? (
                                    <>
            ...
            {isCFModalOpen && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-slate-900 rounded-[3rem] w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-[12px_12px_0px_0px_rgba(71,85,105,0.3)] dark:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.1)] border-2 border-slate-900 dark:border-white/10 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="p-10 flex-1 overflow-auto space-y-8 scrollbar-hide">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-slate-50 dark:bg-white/5 p-8 rounded-[2.5rem] border-2 border-slate-900/5">
                                <div>
                                    ...
                                    <select 
                                        className="w-full px-6 py-4 bg-white dark:bg-slate-800 border-2 border-slate-900/10 dark:border-white/10 rounded-2xl outline-none focus:border-purple-500 font-bold text-slate-900 dark:text-white transition-all appearance-none"
                                        value={cfLeaveTypeId}
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-6 py-4 bg-white dark:bg-slate-800 border-2 border-slate-900/10 dark:border-white/10 rounded-2xl outline-none focus:border-purple-500 font-bold text-slate-900 dark:text-white transition-all tabular-nums"
                                        value={cfMaxLimit}
                            ...
                            {cfLoading ? (
                                        ...
                                        <thead>
                                            <tr className="bg-slate-50/50 dark:bg-purple-500/5 border-b-2 border-slate-900/5">
                                                <th className="p-6 w-20">
                                                    <input 
                                                        type="checkbox"
                                                        className="w-6 h-6 rounded-lg border-2 border-slate-900/10 text-purple-600 focus:ring-purple-500"
                                        ...
                                        <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                                            {cfCandidates.map(c => (
                                                <tr key={c.employee_id} className="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors group">
                                                    ...
                                                    <td className="p-6">
                                                        <div className="flex items-center gap-4">
                                                            <div className="w-10 h-10 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-600 font-black">
                                                                {c.name?.charAt(0)}
                                                            </div>
                                                            <div>
                                ...
                                <div className="text-center py-20 bg-slate-50/50 dark:bg-white/5 rounded-[2.5rem] border-2 border-dashed border-slate-900/10 dark:border-white/10">
                        ...
                        <div className="px-10 py-8 bg-slate-50/50 dark:bg-slate-800/50 border-t-2 border-slate-900/5 dark:border-white/10 flex justify-end gap-4">
                            ...
                            <button 
                                ...
                                className="px-10 py-4 bg-purple-600 hover:bg-purple-700 text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-lg shadow-purple-200 dark:shadow-none active:translate-y-0.5 transition-all flex items-center gap-4 disabled:opacity-50"
                            >
