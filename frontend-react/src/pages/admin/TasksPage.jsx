                            ...
                            <div>
                                ...
                                <div className="p-4 bg-white dark:bg-gray-900 border border-dashed border-gray-300 dark:border-gray-700 rounded-lg">
                                    {selectedTask.proof_attachment ? (
                                        <a href={`http://localhost:8000/storage/${selectedTask.proof_attachment}`} target="_blank" rel="noreferrer" className="flex items-center gap-3 text-blue-600 hover:underline font-semibold text-sm">
