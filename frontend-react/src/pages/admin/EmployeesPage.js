...
const AdminEmployeesPage = () => {
    ...
    const { user } = useAuth();
    const canManage = user?.role_id === 1 || user?.can_manage_employees;
    ...
    const fetchEmployees = async () => {
        setLoading(true);
        try {
            // Using common /employees endpoint accessible to Admin (Role 2)
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900">
            <div className="flex justify-between items-center p-6 border-b bg-white dark:bg-gray-800 dark:border-gray-700">
                <div>
                    <h1 className="text-2xl font-bold text-black font-paperlogy">Employees</h1>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-brand-50 border-b-2 border-black">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-xs font-semibold text-gray-900 uppercase text-center">Reputation</th>
