...
class SalaryController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        // Build CSV in memory — avoids response()->stream() issues on shared hosting
        ob_start();
        ...
        foreach ($salaries as $salary) {
            try {
                ...
                // Skip rows with broken data silently
                \Illuminate\Support\Facades\Log::warning('Salary export row error: ' . $e->getMessage());
            }
        }
